...
<head>
    <title>Admin Panel OmahOutfit</title>
    <!-- Font Awesome -->
    ...
    <div class="container-fluid p-5">
        <div class="col-md-8 offset-md-4 mt-5">
            <div class="card p-2 pt-4" style="width: 30rem;">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url('adminpanel/login/aksi_login') ?>" method="post">
                        ...
                        <input type="submit" class="btn btn-md darken-3 navColor" value="Login" name="Login" />&nbsp
                        <input type="submit" class="btn btn-md darken-3 navColor" value="Back" name="Back" />
                    </form>
                </div>
            </div>
        </div>
